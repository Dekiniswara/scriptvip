...
data_ip="https://raw.githubusercontent.com/Dekiniswara/permission/main/ipmini"
checking_sc() {
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Dekiniswara/permission/main/ipmini | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Dekiniswara/permission/main/ipmini | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Dekiniswara/permission/main/ipmini | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Dekiniswara/scriptvip/main/"
...
wget -q -O /usr/local/sbin/quota "https://raw.githubusercontent.com/Dekiniswara/scriptvip/refs/heads/main/limit/quota"
chmod +x /usr/local/sbin/quota
chmod + x /usr/local/sbin/quota
cd /usr/local/sbin/
sed -i 's/\r//' quota
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/Dekiniswara/scriptvip/refs/heads/main/limit/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
...
wget -q -O /usr/local/geovpn/udp-mini "https://raw.githubusercontent.com/Dekiniswara/project/refs/heads/main/badvpn/udp-mini"
...
mkdir -p /etc/geovpn/
wget -q -O /etc/geovpn/udp "https://raw.githubusercontent.com/Dekiniswara/project/refs/heads/main/ssh/udp"
wget -q -O /etc/systemd/system/udp.service "https://raw.githubusercontent.com/Dekiniswara/project/refs/heads/main/ssh/udp.service"
wget -q -O /etc/geovpn/config.json "https://raw.githubusercontent.com/Dekiniswara/project/refs/heads/main/ssh/config.json"
...
wget -q -O /etc/default/dropbear "https://raw.githubusercontent.com/Dekiniswara/project/refs/heads/main/ssh/dropbear.conf"
...
wget -qO /usr/sbin/ddos.zip "https://raw.githubusercontent.com/Dekiniswara/project/refs/heads/main/ssh/ddos.zip" >/dev/null 2>&1
